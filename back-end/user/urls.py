...
urlpatterns = [
	...
	path('user/oauth2/authorize/<provider>/', views.UserAction.as_view({'get': 'oauth2_authorize'}), name='oauth2_authorize'),
	path('user/oauth2/callback/<provider>/', views.UserAction.as_view({'get': 'oauth2_callback'}), name='oauth2_callback'),
]